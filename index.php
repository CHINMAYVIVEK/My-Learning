        ...
        <nav class="main-menu navbar visible-lg visible-md" data-sticky-header="true">
            ...
            <div class="container">
                    ...
                    <div id="main-menu-navbar-collapse" class="collapse navbar-collapse">
                        <ul class="nav navbar-nav navbar-left">
                            ...
                            <li class="color-theme active">
                                <a href="index.php">Home <span class="nav-line"></span></a>
                            </li>

                            <li class="dropdown color-3">
                                <a href="#" class="dropdown-toggle" data-hover="dropdown">Projects
                ...
                ?>
                            ...
                            <li class="color-4">
                                <a href="#" >Contact<span class="nav-line"></span></a>
                            </li>
                            <li class="color-1">
                                <a href="login/" >Login<span class="nav-line"></span></a>
                            </li>
                               ...
                               if(!($i%2==0))
                                ...
                                <figure class=\"sec-image\">
                                    ...
                                    <div class=\"top-bar\">
                                        ...
                                        <span class=\"btn-srp\"><a href=\"projects.php?prj_id=$cat_id \">{$value['cat_name']}</a></span>
                                    </div>
